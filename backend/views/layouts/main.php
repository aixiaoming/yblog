...
<!--                    <li>-->
<!--                        <a href="#">-->
<!--                            <i class="fa fa-home">文章</i>-->
<!--                            <span class="nav-label"></span>-->
<!--                            <span class="fa arrow"></span>-->
<!--                        </a>-->
<!--                        <ul class="nav nav-second-level">-->
<!--                            <li>-->
<!--                                <a class="J_menuItem" href="--><?// echo Url::to(['article/add'])?><!--" data-index="0">新建文章</a>-->
<!--                            </li>-->
<!--                            <li>-->
<!--                                <a class="J_menuItem" href="--><?// echo Url::to(['article/index'])?><!--">文章列表</a>-->
<!--                            </li>-->
<!--                        </ul>-->
<!--                    </li>-->
<!--                    <li>-->
<!--                        <a class="J_menuItem" href="--><?// echo Url::to(['manager/index'])?><!--"><i class="fa fa-columns"></i> <span class="nav-label">会员管理</span></a>-->
<!--                    </li>-->
